import os
# 强制 SDK 使用 LibUVC/RSUSB 后端，不经过内核 uvcvideo 驱动
# os.environ["LRS_FORCE_LIBUVC"] = "1"
...
import os
# 禁用元数据
os.environ["LRS_LOG_LEVEL"] = "ERROR"
...
if __name__ == '__main__':
    ...
    model = YOLO("/home/xurlang/robot_gripper/src/vi_grab/model/yolov11n.pt")  #通过加载不同的模型，使用yolov8的不同模式，例如yolov8n-pose.pt是人体姿态识别模式，yolov8n.pt是普通检测框模式
